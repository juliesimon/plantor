...
plant_one = Plant.new(name:'1', price_per_day: 50, address: "Paris", category: "Cactus", photo: 'http://power.itp.ac.cn/~jmyang/funny/fun4.jpg' )
plant_two = Plant.new(name:'2', price_per_day: 50, address: "Paris", category: "Cactus", photo: 'http://power.itp.ac.cn/~jmyang/funny/fun4.jpg' )
plant_three = Plant.new(name:'3', price_per_day: 50, address: "Paris", category: "Cactus", photo: 'http://power.itp.ac.cn/~jmyang/funny/fun4.jpg' )
plant_four = Plant.new(name:'4', price_per_day: 50, address: "Paris", category: "Cactus", photo: 'http://power.itp.ac.cn/~jmyang/funny/fun4.jpg' )
